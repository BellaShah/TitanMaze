...
public class ExampleLevel extends AbstractLevel {
    ...
    public ExampleLevel() {
        ...
        */
        ...
        addVerticalObstacle(2 , 6, 2 , 6 , 0.5 , Color.BLUE, Color.BLACK );

        //add horizontal moving obstacle which moves from left to right
        addHorizontalObstacle(6 , 2, 2 , 6 , 0.5 , Color.BLUE, Color.BLACK );
